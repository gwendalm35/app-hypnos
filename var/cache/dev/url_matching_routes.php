...
return [
    ...
    [ // $regexpList
        0 => '{^(?'
                .'|/_(?'
                    ...
                    .')'
                .')'
                .'|/espace\\-client/reservation/supprimer/([^/]++)(*:215)'
                .'|/nos\\-suites/([^/]++)(*:244)'
    ...
    [ // $dynamicRoutes
        ...
        215 => [[['_route' => 'reservation_delete', '_controller' => 'App\\Controller\\ClientAreaController::delete'], ['id'], ['POST' => 0, 'DELETE' => 1], null, false, true, null]],
        244 => [[['_route' => 'app_hotel_rooms', '_controller' => 'App\\Controller\\HotelRoomsController::index'], ['id'], null, null, false, true, null]],
        288 => [

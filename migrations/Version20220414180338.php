 ...
 */
final class Version20220414180338 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE galerie (id INT AUTO_INCREMENT NOT NULL, room_galerie_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, INDEX IDX_9E7D1590B6A1E6D7 (room_galerie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE galerie ADD CONSTRAINT FK_9E7D1590B6A1E6D7 FOREIGN KEY (room_galerie_id) REFERENCES hotel_rooms (id)');
